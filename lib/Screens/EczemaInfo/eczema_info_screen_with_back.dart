...
class ViewInfoScreenWithBack extends StatefulWidget {
  const ViewInfoScreenWithBack({Key? key}) : super(key: key);

  @override
  _ViewInfoScreenWithBackState createState() => _ViewInfoScreenWithBackState();
}

class _ViewInfoScreenWithBackState extends State<ViewInfoScreenWithBack> {
