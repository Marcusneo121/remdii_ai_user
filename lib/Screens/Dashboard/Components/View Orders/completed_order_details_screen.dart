...
import 'package:fyp/Screens/Dashboard/Components/View%20Orders/completed_order_item_card.dart';
...
class CompletedOrderDetails extends StatefulWidget {
  const CompletedOrderDetails({Key? key, required this.order})
      : super(key: key);
  final Order order;
                          ...
                          ListView(
                            ...
                            children: [
                              ...
                              ListTile(
                                ...
                                subtitle: Text(
                                  '${widget.order.comDate} \n${widget.order.comTime}',
                                  style: TextStyle(
                                    fontFamily: 'Lato',
                                    fontWeight: FontWeight.w800,
                                    fontSize: 15.0,
