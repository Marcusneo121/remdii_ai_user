...
class PSeries6Tab extends StatefulWidget {
  const PSeries6Tab({Key? key}) : super(key: key);

  @override
  _PSeries6TabState createState() => _PSeries6TabState();
}

class _PSeries6TabState extends State<PSeries6Tab> {
  ...
  fetchProductData() async {
    try {
      ...
      var results = await conn.query(
          'SELECT * FROM products WHERE series_id = 6');
