...
class PSeries5Tab extends StatefulWidget {
  const PSeries5Tab({Key? key}) : super(key: key);

  @override
  _PSeries5TabState createState() => _PSeries5TabState();
}

class _PSeries5TabState extends State<PSeries5Tab> {
  ...
  fetchProductData() async {
    try {
      ...
      var results = await conn.query(
          'SELECT * FROM products WHERE series_id = 5');
