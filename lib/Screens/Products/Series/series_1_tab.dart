...
class PSeries1Tab extends StatefulWidget {
  const PSeries1Tab({Key? key}) : super(key: key);

  @override
  _PSeries1TabState createState() => _PSeries1TabState();
}

class _PSeries1TabState extends State<PSeries1Tab> {
  ...
  fetchProductData() async {
    try {
      ...
      var results = await conn.query(
          'SELECT * FROM products WHERE series_id = 1');
      print(results);
