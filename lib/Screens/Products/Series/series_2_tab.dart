...
class PSeries2Tab extends StatefulWidget {
  const PSeries2Tab({Key? key}) : super(key: key);

  @override
  _PSeries2TabState createState() => _PSeries2TabState();
}

class _PSeries2TabState extends State<PSeries2Tab> {
  ...
  fetchProductData() async {
    try {
      ...
      var results = await conn.query(
          'SELECT * FROM products WHERE series_id = 2');
