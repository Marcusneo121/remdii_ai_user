...
class PSeries3Tab extends StatefulWidget {
  const PSeries3Tab({Key? key}) : super(key: key);

  @override
  _PSeries3TabState createState() => _PSeries3TabState();
}

class _PSeries3TabState extends State<PSeries3Tab> {
  ...
  fetchProductData() async {
    try {
      ...
      var results = await conn.query(
          'SELECT * FROM products WHERE series_id = 3');
